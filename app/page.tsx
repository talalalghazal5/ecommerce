      ...
      <main className="flex min-h-screen w-full items-center justify-around">
        <div>
          <h1 className="text-5xl font-bold">Shopping became <span className="font-rouge text-7xl text-amber-500">premium.</span></h1>
            ...
            <Button className="bg-blue-700 cursor-pointer hover:bg-blue-900" size={"lg"}>Go shopping</Button>
        </div>
        <div className="relative">
          ...
          <Image src={thirdHeroImage} alt="second hero image" width={300} height={300} className="absolute bottom-[-10] right-40"></Image>
        </div> 
      </main>
    </div>
  );
